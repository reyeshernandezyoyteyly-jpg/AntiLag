...
print("⚔️ ANTI-LAG - ESPERANDO CONTRASEÑA")
    ...
    function ejecutarOptimizaciones()
        ...
        pcall(function()
            ...
            local mejoras = {
                ...
                {texto = "edificios protegidos", color = Color3.fromRGB(0, 255, 0)}
            }
        ...
        pcall(function()
            ...
            for _, obj in pairs(Workspace:GetDescendants()) do
                pcall(function()
                    if not esEdificio(obj) and not esDummy(obj) then
                        local nombre = obj.Name and string.lower(obj.Name) or ""
        ...
        print("✅ ANTI-LAG ACTIVADO - Edificios protegidos")
    end
